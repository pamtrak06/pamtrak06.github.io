...
// --------------------------------------------
buildMapcacheXmlFromContent = (function(capabilitiesXmlContent, urlRequestCapa, projectName) {
    var parser = new ol.parser.ogc.WMSCapabilities(), capabilitiesXmlContent;
    capabilitiesXmlContent = parser.read(capabilitiesXmlContent);
    
    var layers = capabilitiesXmlContent.capability.layers;
...
buildMapcacheXml = (function(capabilitiesFile, urlRequestCapa, projectName) {
    ...
    if (xhr.status == 200) {
        mapcache = buildMapcacheFromXml(result, urlRequestCapa, projectName);
    }
    return mapcache;
});
